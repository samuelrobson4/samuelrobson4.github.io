...
export type BouncyBlogBubblesRef = {
  shuffle: () => void;
...
export const BouncyBlogBubbles = forwardRef<BouncyBlogBubblesRef, Props>(function BouncyBlogBubbles(
  {
    cards,
    width = '90%',
    height = 480,
  ...
  return (
    <div
      ...
      aria-label="bouncy blog bubbles"
    >
      {cards.map((card) => (
        <div
          key={card.id}
...
export default BouncyBlogBubbles;
